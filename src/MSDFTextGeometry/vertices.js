...
function attributes(glyphs, texWidth, texHeight, flipY, layout) {
    ...
    const numVerticesPerGlyph = 16;

    const uvs = new Float32Array(glyphs.length * numVerticesPerGlyph * 2);
    const layoutUvs = new Float32Array(glyphs.length * numVerticesPerGlyph * 2);
    const positions = new Float32Array(glyphs.length * numVerticesPerGlyph * 2);
    const centers = new Float32Array(glyphs.length * numVerticesPerGlyph * 2);
